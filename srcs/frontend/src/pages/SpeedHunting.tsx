...
const SpeedHunting = () => {
    ...
    return (
        <div className="bg-black text-white min-h-screen overflow-x-hidden">
            ...
            <section id="sobre" className="px-8 xl:px-20 py-20 border-b border-white/10">
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    ...
                    <div className="flex-1">
                        <SectionHeader
                            label="The Wall · O Que É?"
                            title={<>O QUE É O<br /><span className="text-[#c8ff00]">SPEED HUNTING?</span></>}
                            className="mb-6"
                        />
            ...
            <section id="empresas" className="px-16 xl:px-32 py-24 border-b border-white/10 bg-white/[0.02]">
                <div className="mb-10 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                    <SectionHeader
                        ...
                        title={<>EMPRESAS <span className="text-[#c8ff00]">CONFIRMADAS</span></>}
                    />
                </div>
                ...
                <div className="mb-12">
                    <FilterBox
                        ...
                        labelMap={speedHuntingCategoryLabel}
                    />
                </div>
            ...
            <section id="como-funciona" className="px-8 xl:px-20 py-20 border-b border-white/10">
                <div className="flex flex-col lg:flex-row gap-16">
                    ...
                    <div className="flex-1">
                        <SectionHeader
                            label="Como Funciona"
                            title={<>O <span className="text-[#c8ff00]">PROCESSO</span></>}
                            className="mb-10"
                        />
                    ...
                    <div className="flex-1">
                        <SectionHeader
                            label="Dicas para Alunos"
                            title={<>VEM <span className="text-[#c8ff00]">PREPARADO</span></>}
                            className="mb-10"
                        />
            ...
            <CtaBannerSection
                alignRight
                headline={<><span className="text-[#c8ff00]">DOIS</span> DIAS. <br /><span className="text-[#c8ff00]">DEZENAS</span> PROJETOS.<br /><span className="text-[#c8ff00]">INÚMERAS</span> OPORTUNIDADES.<br /></>}
                rightSlot={
