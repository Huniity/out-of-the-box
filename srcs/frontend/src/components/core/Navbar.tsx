                        ...
                        {visibleLinks.map((link) => {
                            ...
                            return (
                                <li key={link.href}>
                                    <a
                                        href={link.href}
                                        className={`inline-block relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-[2px] after:bg-[#c8ff00] after:transition-all after:duration-300 ${isActive ? 'after:w-full text-[#c8ff00] pointer-events-none' : 'after:w-0 hover:after:w-full'}`}
                                    >
