      ...
      <div className="relative z-10 flex flex-col gap-12 md:flex-row md:items-center">
        ...
        <div className="flex flex-1 flex-col">
          ...
          <h2 className="text-left font-black text-4xl xl:text-5xl uppercase leading-none tracking-tight">
            ...
            <span className="text-[#c6dc80]">  ETIC?</span>
          </h2>

          <div className="my-5 h-[2px] w-16 bg-[#c6dc80] opacity-50" />
          ...
          <a
            href="/cursos"
            className="mt-24 group inline-flex w-fit items-center gap-2 rounded-sm border-2 border-[#c6dc80] bg-[#c6dc80] px-5 py-2 text-xs font-black uppercase tracking-widest text-black transition-colors duration-200 hover:bg-transparent hover:text-[#c6dc80]"
          >
            Saber mais
