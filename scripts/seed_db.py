...
def seed_database():
    ...
    Exposicoes.objects.bulk_create([
        Exposicoes(
            ...
            category="DESIGN",
            synopsis="Uma exposição que explora a intersecção entre design gráfico, tipografia e tecnologia emergente. Os formandos apresentam identidades visuais, sistemas de branding e peças de comunicação que desafiam os limites do design contemporâneo.",
        ...
        Exposicoes(
            ...
            category="JOGOS",
            synopsis="Jogos indie, instalações interativas e protótipos desenvolvidos pelos formandos de Videojogos. Uma viagem pelos mundos criados em Unity e Unreal Engine, onde a narrativa e o gameplay se fundem com a arte.",
    ...
    Cinema.objects.bulk_create([
        ...
        Cinema(
            ...
            synopsis="Programa de cinco curtas-metragens de géneros distintos — ficção, documentário, videoclipe e experimental — realizadas pelos formandos finalistas das turmas de Cinema e TV.",
            duration="75 minutos",
    ...
    Concertos.objects.bulk_create([
        Concertos(
            ...
            description="O concerto de abertura do Out of the Box 2026. Live In Sight é o projeto musical dos formandos de Som e Áudio da ETIC_Algarve — uma noite de estreias ao vivo que dá o pontapé de saída ao festival.",
        ...
        Concertos(
            ...
            description="Duo de música eletrónica e voz formado por ex-formandos da ETIC_Algarve. As suas composições exploram sonoridades ambientais e letras em português que falam de identidade e território.",
        ...
        Concertos(
            band_name="Happening dos formandos",
            description="Encerramento do festival com uma performance coletiva dos formandos de Som, incluindo DJ sets, produções ao vivo e colaborações surpresa com convidados especiais. Uma noite para celebrar 15 dias de criatividade.",
    ...
    page = Page.objects.bulk_create([
        Page(name="Exposições",  is_live=True,  main_white_title="A Obra Ganha", main_green_title="Vida", main_description="Descobre as exposições que revelam o talento e a criatividade dos formandos das áreas de Design, Fotografia e Videojogos.", start_event_date=date(2026, 7, 3), end_event_date=date(2026, 7, 17)),
        ...
        Page(name="Concertos", is_live=True, main_white_title="Concertos", main_green_title="Live", main_description="A música ao vivo e os happenings dão ritmo ao Out of the Box. Aqui encontras o evento de abertura Live In Sight e todas as atuações dos formandos durante o festival.", cta_button_text="Live In Sight ", cta_button_link="https://www.eticalgarve.com/comunidade/live-insight/", start_event_date=date(2026, 7, 3), end_event_date=date(2026, 7, 17)),
        Page(name="Speed Hunting", is_live=True, main_white_title="Speed", main_green_title="Hunting", main_description="Encontros rápidos entre empresas e formandos da ETIC_Algarve para apresentação de portfólio, conversa profissional e criação de oportunidades.", cta_button_text="Sabe mais sobre a programação", cta_button_link="/programacao#sessoes", start_event_date=date(2026, 7, 9), end_event_date=date(2026, 7, 10)),
